export const metadata = {
  ...
  description: 'Get started with Power Platform Tool Box platform development - setup, build, and contribute to the core application',
}
...
Learn how to set up your development environment and contribute to the Power Platform Tool Box platform itself. {{ className: 'lead' }}
