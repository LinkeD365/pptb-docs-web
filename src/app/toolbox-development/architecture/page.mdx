export const metadata = {
  title: 'Architecture',
  description: 'Understanding the architecture of Power Platform Tool Box - components, data flow, and design patterns',
}
...
A comprehensive guide to the architecture of Power Platform Tool Box - an Electron-based desktop application built with TypeScript, Vite, and a modular design. {{ className: 'lead' }}
