export const metadata = {
  ...
  description: 'Complete guide for developing tools for Power Platform Tool Box using webview-based architecture with secure APIs',
}
...
Power Platform Tool Box provides a secure, extensible platform for creating custom tools as web applications. This guide will help you build, test, and publish your own tools. {{ className: 'lead' }}
